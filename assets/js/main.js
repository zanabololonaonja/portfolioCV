...
(function() {
    /**
     * Animation automatique des images dans la section portfolio
     */
    function animatePortfolioImages() {
      document.querySelectorAll('.portfolio-carousel').forEach(carousel => {
        ...
        if (images.length > 1) {
          ...
          carousel.dataset.carouselInterval = interval;
        } else if (images.length === 1) {
          images[0].classList.add('active');
        }
      });
    }
    window.addEventListener('DOMContentLoaded', animatePortfolioImages);
